...
import mone.api.process.*;
import mone.api.selection.ISelectionManager;
import mone.api.utils.IInputOverrideHandler;
import mone.api.utils.IPlayerContext;

/**
 */
public interface IMone {
    ...
    /**
     * Returns the {@link IPathingControlManager} for this {@link IMone} instance, which is responsible
     * for managing the {@link IMoneProcess}es which control the {@link IPathingBehavior} state.
     *
