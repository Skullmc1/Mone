...
package mone.api.pathing.goals;
 ...
 * current goal. This goal just reverses the heuristic to act as a TRUE invert. Inverting a Y level? Mone tries to
 * get away from that Y level. Inverting a GoalBlock? Mone will try to make distance whether it's in the X, Y or Z
