...
public class GoalAxis implements Goal {
    ...
    public boolean isInGoal(int x, int y, int z) {
        return y == MoneAPI.getSettings().axisHeight.value && (x == 0 || z == 0 || Math.abs(x) == Math.abs(z));
    }
    ...
    public double heuristic(int x0, int y, int z0) {
        ...
        return flatAxisDistance * MoneAPI.getSettings().costHeuristic.value + GoalYLevel.calculate(MoneAPI.getSettings().axisHeight.value, y);
    }
