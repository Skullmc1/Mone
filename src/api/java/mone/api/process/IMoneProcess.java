...
import mone.api.event.events.PathEvent;

/**
 * A process that can control the PathingBehavior.
 * <p>
 * Differences between a Mone process and a behavior:
 * <ul>
 * <li>Only one Mone process can be active at a time</li>
...
public interface IMoneProcess {
    ...
    /**
     * Called when this process is in control of pathing; Returns what Mone should do.
     *
