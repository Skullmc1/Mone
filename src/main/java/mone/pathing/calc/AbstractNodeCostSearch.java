...
import mone.api.pathing.calc.IPathFinder;
...
public abstract class AbstractNodeCostSearch implements IPathFinder, Helper {
    ...
    /**
     * @see <a href="https://github.com/cabaletta/Mone/issues/107">Issue #107</a>
     */
    ...
    AbstractNodeCostSearch(BetterBlockPos realStart, int startX, int startY, int startZ, Goal goal, CalculationContext context) {
        ...
        this.map = new Long2ObjectOpenHashMap<>(MoneAPI.getSettings().pathingMapDefaultSize.value, MoneAPI.getSettings().pathingMapLoadFactor.value);
    }
