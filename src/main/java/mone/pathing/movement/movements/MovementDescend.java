...
public class MovementDescend extends Movement {
    ...
    public MovementDescend(IMone Mone, BetterBlockPos start, BetterBlockPos end) {
        super(Mone, start, end, new BetterBlockPos[]{end.above(2), end.above(), end}, end.below());
    }
    ...
    public MovementState updateState(MovementState state) {
        ...
        state.setInput(Input.SNEAK, MoneAPI.getSettings().allowWalkOnMagmaBlocks.value && ctx.world().getBlockState(ctx.player().blockPosition().below()).is(Blocks.MAGMA_BLOCK));
