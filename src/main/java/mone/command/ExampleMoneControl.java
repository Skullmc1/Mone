...
public class ExampleMoneControl extends Behavior implements Helper {

    private static final Settings settings = MoneAPI.getSettings();
    private final ICommandManager manager;

    public ExampleMoneControl(Mone Mone) {
        super(Mone);
        this.manager = Mone.getCommandManager();
    }
