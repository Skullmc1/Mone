...
import mone.KeepName;
import mone.api.IMone;
import mone.api.command.Command;
import mone.api.command.argument.IArgConsumer;
import mone.api.command.datatypes.EntityClassById;
import mone.api.command.datatypes.IDatatypeFor;
import mone.api.command.datatypes.NearbyPlayer;
import mone.api.command.exception.CommandErrorMessageException;
...
public class FollowCommand extends Command {
    ...
    public FollowCommand(IMone Mone) {
        super(Mone, "follow");
    }
    ...
    public void execute(String label, IArgConsumer args) throws CommandException {
        ...
        if (args.hasExactlyOne()) {
            Mone.getFollowProcess().follow((group = args.getEnum(FollowGroup.class)).filter);
        } else {
            args.requireMin(2);
            group = null;
    ...
    public List<String> getLongDesc() {
        return Arrays.asList(
                "The follow command tells Mone to follow certain kinds of entities.",
                "",
                "Usage:",
