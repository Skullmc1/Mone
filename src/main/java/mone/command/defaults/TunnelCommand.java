...
import mone.api.pathing.goals.GoalStrictDirection;
...
public class TunnelCommand extends Command {
    ...
    public TunnelCommand(IMone Mone) {
        super(Mone, "tunnel");
    }
    ...
    public void execute(String label, IArgConsumer args) throws CommandException {
        ...
        if (args.hasExactly(3)) {
            ...
            if (cont) {
                ...
                Mone.getBuilderProcess().clearArea(corner1, corner2);
            }
        } else {
    ...
    public List<String> getLongDesc() {
        return Arrays.asList(
                "The tunnel command sets a goal that tells Mone to mine completely straight in the direction that you're facing.",
                "",
                "Usage:",
