...
public class RepackCommand extends Command {
    ...
    public RepackCommand(IMone Mone) {
        super(Mone, "repack", "rescan");
    }

    @Override
    public void execute(String label, IArgConsumer args) throws CommandException {
        args.requireMax(0);
        logDirect(String.format("Queued %d chunks for repacking", MoneAPI.getProvider().getWorldScanner().repack(ctx)));
    }
