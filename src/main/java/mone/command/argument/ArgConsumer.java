...
import mone.api.command.datatypes.IDatatype;
import mone.api.command.datatypes.IDatatypeContext;
import mone.api.command.datatypes.IDatatypeFor;
import mone.api.command.datatypes.IDatatypePost;
import mone.api.command.exception.CommandException;
import mone.api.command.exception.CommandInvalidTypeException;
import mone.api.command.exception.CommandNotEnoughArgumentsException;
import mone.api.command.exception.CommandTooManyArgumentsException;
...
public class ArgConsumer implements IArgConsumer {
    ...
    public <T, O, D extends IDatatypePost<T, O>> T getDatatypePost(D datatype, O original) throws CommandInvalidTypeException, CommandNotEnoughArgumentsException {
        try {
            ...
            if (MoneAPI.getSettings().verboseCommandExceptions.value) {
                e.printStackTrace();
            }
