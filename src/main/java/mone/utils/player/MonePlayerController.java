...
import mone.api.utils.IPlayerController;
import mone.utils.accessor.IPlayerControllerMP;
 ...
 *
 */
public final class MonePlayerController implements IPlayerController {

    private final Minecraft mc;

    public MonePlayerController(Minecraft mc) {
        this.mc = mc;
    }
