...
public final class PathRenderer implements IRenderer {
    ...
    public static double posX() {
        return IRenderer.getRenderManager().renderPosX();
    }

    public static double posY() {
        return IRenderer.getRenderManager().renderPosY();
    }

    public static double posZ() {
        return IRenderer.getRenderManager().renderPosZ();
    }
    ...
    public static void render(RenderEvent event, PathingBehavior behavior) {
        ...
        final DimensionType currentRenderViewDimension = MoneAPI.getProvider().getPrimaryMone().getPlayerContext().world().dimensionType();
    ...
    public static void drawManySelectionBoxes(PoseStack stack, Entity player, Collection<BlockPos> positions, Color color) {
        ...
        BlockStateInterface bsi = new BlockStateInterface(MoneAPI.getProvider().getPrimaryMone().getPlayerContext()); // TODO this assumes same dimension between primary Mone and render view? is this safe?
