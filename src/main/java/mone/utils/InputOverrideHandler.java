...
public final class InputOverrideHandler extends Behavior implements IInputOverrideHandler {
    ...
    public InputOverrideHandler(Mone Mone) {
        super(Mone);
        this.blockBreakHelper = new BlockBreakHelper(Mone.getPlayerContext());
        this.blockPlaceHelper = new BlockPlaceHelper(Mone.getPlayerContext());
    }
    ...
    private boolean inControl() {
        ...
        return Mone.getPathingBehavior().isPathing() || Mone != MoneAPI.getProvider().getPrimaryMone();
    }
