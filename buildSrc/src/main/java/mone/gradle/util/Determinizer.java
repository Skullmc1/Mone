        ...
        try (
            ...
            for (JarEntry entry : entries) {
                ...
                if (entry.getName().endsWith(".refmap.json")) {
                    ...
                    if (!manifest.contains("Mone.launch.tweaker.BaritoneTweaker")) {
                        throw new IllegalStateException("unable to replace");
                    }
                    manifest = manifest.replace("Mone.launch.tweaker.BaritoneTweaker", "org.spongepowered.asm.launch.MixinTweaker");
